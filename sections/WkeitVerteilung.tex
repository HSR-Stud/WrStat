...
\begin{minipage}{0.4\textwidth}
	\input{tikz/bspVerteilungsfunktion.tex}\\
...
\end{minipage}
\begin{minipage}{6cm}
	\input{tikz/Normalverteilung.tex}
\end{minipage}
\hrule
...
\begin{minipage}{0.3\textwidth}
	\input{tikz/HypergeomVerteilung.tex}
\end{minipage}
...
\hrule
      ...
      \columnbreak
        ...
        \end{tabular}
      \columnbreak
      	\input{tikz/Gleichverteilung.tex}\\ 
