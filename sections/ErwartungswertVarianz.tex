...
\subsection{Erwartungswert \skript{\pageref{sk-section-erwartungswert}}}
...
\hspace{1cm}
\begin{minipage}[t]{9cm}
\subsubsection{Rechenregeln \skript{\pageref{sk-rechenregeln-erwartungswert}}}
\begin{tabular}{ll}
  $E(X+Y)=E(X)+E(Y)$ \\
...
\begin{minipage}{9cm}
\subsection{Varianz \skript{\pageref{sk-section-varianz}}}
  \begin{tabular}{ll}
...
\end{minipage}
\begin{minipage}{9cm}
  \subsubsection{Rechenregeln \skript{\pageref{sk-rechenregeln-varianz}}}
  \begin{tabular}{ll}
...
\subsection{Erwartungswert und Varianz des arithmetischen Mittels \skript{\pageref{sk-approximation-mittelwert}}}
